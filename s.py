			...
			for vanilla in id2:
				...
				if len(namamu_kusimpan)<6:
					if len(aink_tersakiti)<3:
						...
						muhammad_arif_xr.append(aink_tersakiti+'123');muhammad_arif_xr.append(aink_tersakiti+'1234');muhammad_arif_xr.append(aink_tersakiti+'12345');muhammad_arif_xr.append(aink_tersakiti+'123456');	muhammad_arif_xr.append(aink_tersakiti+'54321');muhammad_arif_xr.append(aink_tersakiti+'321')
				else:
					if len(aink_tersakiti)<3:
